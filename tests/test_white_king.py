...
class TestWhiteKing(unittest.TestCase):
    ...
    def test_invalid_castling_after_king_movement(self):
        self.white_king.movement_manager(self.origin_square, 5)
        self.chess_board.change_turn()
        self.white_king.movement_manager(5, 4)
        self.chess_board.change_turn()
        self.white_king.movement_manager(self.origin_square, 6)
        self.white_king.movement_manager(self.origin_square, 2)
        assert self.chess_board.is_white_king_on_square(self.origin_square)
