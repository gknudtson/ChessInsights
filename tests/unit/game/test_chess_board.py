...
class TestChessBoard(unittest.TestCase):
    ...
    def test_is_piece_on_square(self):
        ...
        self.chess_board = ChessBoard(
            board_state=self.chess_board.get_move_board_state(Square.e2.value, square))
    ...
    def test_find_piece_on_square(self):
        ...
        new_board = ChessBoard(board_state=self.chess_board.get_move_board_state(Square.c2.value, square))
    ...
    def test_castling_rights_update(self):
        ...
        new_board = ChessBoard(
            board_state=board.get_move_board_state(Square.h1.value, Square.h2.value))  # Move white rook
    ...
    def test_pawn_capture(self):
        ...
        self.chess_board = ChessBoard(
            board_state=board.get_move_board_state(Square.e4.value, Square.d5.value))
    ...
    def test_en_passant(self):
        ...
        self.chess_board = ChessBoard(
            board_state=board.get_move_board_state(Square.e5.value, Square.f6.value))
    ...
    def test_castling_kingside(self):
        ...
        new_board = ChessBoard(
            board_state=self.chess_board.get_move_board_state(Square.e1.value, Square.g1.value))
    ...
    def test_castling_queenside(self):
        ...
        self.chess_board = ChessBoard("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1")
        new_board = ChessBoard(
            board_state=self.chess_board.get_move_board_state(Square.e1.value, Square.c1.value))
    ...
    def test_invalid_move(self):
        ...
        with self.assertRaises(ValueError):
            self.chess_board.get_move_board_state(Square.e2.value,
    ...
    def test_piece_movement(self):
        ...
        new_board = ChessBoard(
            board_state=self.chess_board.get_move_board_state(Square.e2.value, Square.e4.value)
        )
    ...
    def test_capture_piece(self):
        ...
        board = ChessBoard(board_state=board.get_move_board_state(Square.e2.value, Square.e4.value))
        board = ChessBoard(board_state=board.get_move_board_state(Square.d7.value, Square.d5.value))
        board = ChessBoard(board_state=board.get_move_board_state(Square.e4.value, Square.d5.value))
    ...
    def test_pawn_promotion(self):
        ...
        new_board = ChessBoard(board_state=board.get_move_board_state(Square.e7.value, Square.e8.value))
    ...
    def test_en_passant_failure(self):
        ...
        with self.assertRaises(ValueError):
            self.chess_board = ChessBoard(
                board_state=self.chess_board.get_move_board_state(Square.f5.value, Square.e6.value))
